...
if __name__ == '__main__':
    ...
    chunks_dict= {}
    list_of_dfs = list()
    for symbolIDX in [10, 14, 15, 16, 28, 36]:
        print('processing symbol:', symbolIDX, symbols[symbolIDX])

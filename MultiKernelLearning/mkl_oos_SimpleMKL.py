...
dir_loc = 'SimpleMKL'
mklOOSPredictionPathSpecific = os.path.join(mklOOSPredictionPath, dir_loc)
...
if __name__ == '__main__':
    ...
    symbol_idx = 4# pick Nov28 DownNa symbol in the list
                    ...
                    if hmm_features.isnull().values.all():  # checking that the HMM features are actually not null
                        ...
                        if Xtr.shape[0]<10:
                            ...
                            try:
                                ...
                                y_score = clf.decision_function(KLtr)

...
class TwoSampleKernelPython():
    ...
    def compute_null_distribution(self, m, n, iterations=10000, verbose=False,
...
def kernel_two_sample_test(X, Y, kernel_function='rbf', iterations=10000,
    ...
    mmd2u = TwoSampleKernelPython.MMD2u(K, m, n)
    if verbose:
        print("MMD^2_u = %s" % mmd2u)
        print("Computing the null distribution.")

    mmd2u_null = TwoSampleKernelPython.MMD2ucompute_null_distribution(K, m, n, iterations,
                                                                      verbose=verbose,
